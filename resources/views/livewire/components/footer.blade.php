    ...
    <div class="lg:flex lg:justify-evenly">
        ...
        <div class="mt-6 text-center lg:mt-0">
            ...
            <ul>
                ...
                <li>
                    <a href="" class="block py-2 text-gray-600">About us</a>
                </li>
                <li>
                    <a href="" class="block py-2 text-gray-600">Contact Us</a>
                </li>
            </ul>
        </div>
        <div class="mt-6 text-center lg:mt-0">
            ...
            <ul>
                <li>
                    <a href="" class="block py-2 text-gray-600">Property</a>
                </li>
                <li>
                    <a href="" class="block py-2 text-gray-600">About us</a>
                </li>
                <li>
                    <a href="" class="block py-2 text-gray-600">Help</a>
                </li>
            </ul>
        </div>
        <div class="mt-6 text-center lg:mt-0">
            ...
            <ul>
                <li>
                    <a href="" class="block py-2 text-gray-600">FAQ</a>
                </li>
                <li>
                    <a href="" class="block py-2 text-gray-600">About us</a>
                </li>
                <li>
                    <a href="" class="block py-2 text-gray-600">New Property</a>
                </li>
            </ul>
        </div>
    </div>
