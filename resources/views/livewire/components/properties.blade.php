  <!-- All Property -->
            <section class="px-4 py-4 bg-gray-200 lg:px-20 lg:py-8">
                <div class="mt-4 space-y-2 lg:gap-4 lg:flex lg:justify-center lg:items-center lg:flex-wrap lg:mt-20">
                    <div class="p-4 bg-white rounded-lg">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-2">
                                <span class="text-xl font-extrabold text-blue-600">$3000.00</span>
                                /M
                        ...
                        <div class="flex justify-center items-center w-full">
                            <a href="{{ route('property-details')}}" class="flex justify-center items-center w-1/2 text-base font-bold cursor-pointer border-2 border-solid border-blue-600 rounded-md px-4 py-3 text-orange-500">More Details</a>
                        </div>
                    </div>
                    <div class="p-4 bg-white rounded-lg">
                ...
                <div class="container flex justify-center mx-auto mt-8">
                    <ul class="flex">
                        <li>
                            <button class="h-10 px-5 text-gray-600 bg-white border border-r-0 border-gray-600 hover:bg-gray-100">Prev</button>
                        </li>
                        <li>
                            <button class="h-10 px-5 text-gray-600 bg-white border border-r-0 border-gray-600 ">1</button>
                        </li>
                        <li>
                            <button class="h-10 px-5 text-gray-600 bg-white border border-r-0 border-gray-600 hover:bg-gray-100">2</button>
                        </li>
                        <li>
                            <button class="h-10 px-5 text-white bg-gray-600 border border-r-0 border-gray-600 ">3</button>
                        </li>
                        <li>
                            <button class="h-10 px-5 text-gray-600 bg-white border border-gray-600 hover:bg-gray-100">Next</button>
                        </li>
                    </ul>
                </div>
            </section>