  ...
  {{-- <section class="px-4 py-4 bg-gray-200 lg:px-20 lg:py-8">
                <div class="mt-4 space-y-2 lg:gap-4 lg:flex lg:justify-center lg:items-center lg:flex-wrap lg:mt-20">
                    ...
                    <div class="p-4 bg-white rounded-lg">
                            ...
                            <div class="p-6">
                                <h4 class="text-2xl font-bold cursor-pointer">{{$allProperties->title}}</h4>
                           
                                <div class="mt-2">
                                    <span class="text-xl font-extrabold text-blue-600">{{$allProperties->propertyInfo->price_php}}</span>
                            ...
                            <div class="flex justify-between p-4 text-gray-700 border-t border-gray-300">
                                <div class="flex items-center">
                                    ...
                                    <p>
                                        <span class="font-bold text-gray-900">{{$allProperties->propertyInfo->bedrooms}}</span>
                                        Bedrooms
                                    </p>
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <p>
                                        <span class="font-bold text-gray-900">{{$allProperties->propertyInfo->bathrooms}}</span>
                                        Bathrooms
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex justify-center items-center w-full">
                                <a href="{{ route('property-details', ['id' => $allProperties->id]) }}" class="flex justify-center items-center w-1/2 text-base font-bold cursor-pointer border-2 border-solid border-blue-600 rounded-md px-4 py-3 text-orange-500">More Details</a>
                            </div>
                        </div>
