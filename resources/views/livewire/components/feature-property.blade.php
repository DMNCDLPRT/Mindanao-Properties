    ...
    <div class="slide-container swiper my-10">
        <div class="mb-7">
        ...
        <div class="slide-content">
            <div class="card-wrapper swiper-wrapper">
                ...
                @foreach ($properties as $allProperties)
                    <div class="relative mx-auto w-full card swiper-slide">
                        <a href="{{ route('property-details', ['id' => $allProperties->id]) }}"
                            ...
                            <div class="shadow p-4 rounded-lg bg-white">
                                <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                                    ...
                                    @if (
                                        $allProperties->propertyClassification->type->name != 'Land' &&
                                    ...
                                    <p class="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                                        ...
                                        <span class="mt-2 xl:mt-0">
                                            {{ $allProperties->propertyInfo->fully_furnished != 'Yes'
                                                ? ($allProperties->propertyInfo->fully_furnished == 'Semi'
                                                    ? 'Semi-Furnished'
                                                    : 'Unfurnished')
                                                : 'Furnished' }}
                                        </span>
                                ...
                                <div class="grid grid-cols-2 mt-8">
                                    <div class="flex items-center">
                                        <div class="relative">
                                            <div class="rounded-full w-6 h-6 md:w-8 md:h-8 bg-gray-200">
                                                ...
                                                <img src="{{ asset($allProperties->user->profile_photo_url) }}"
                                    ...
                                    <div class="flex justify-end">
                                        <p
                                            ...
                                            <span
                                                class="text-lg">{{ $allProperties->propertyInfo->price_php }}</span>/m
                                        </p>
                                    </div>
                                </div>
