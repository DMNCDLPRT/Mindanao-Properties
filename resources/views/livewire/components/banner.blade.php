<section class="p-12 text-center bg-gradient-to-r from-blue-200 to-purple-500 lg:p-56">
    <h1 class="mb-2 text-2xl font-bold text-gray-700 lg:text-5xl">Find Your Dream Home</h1>
    <p class="mb-8 text-lg text-center text-gray-700">Lorem ipsum dolor sit, amet consectetur adipisicing
        elit.
