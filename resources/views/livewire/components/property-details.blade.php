            ...
            <div class="bg-white flex flex-col min-h-302 top-20 shadow-md rounded-md px-20 sticky">
                <div class="h-auto">
                    ...
                    <div class="flex items-ceneter justify-center mb-10">
                        ...
                        <a href="" class="text-lg text-orange font-bold cursor-pointer">Show Number</a>
                    </div>
                </div>
                <div class="flex flex-1 flex-col justify-center">
                    <a href="" class="flex justify-center items-center mb-10 text-base font-bold cursor-pointer border-2 border-solid border-blue-600 rounded-md px-4 py-3 text-orange-500">Inquire</a>
